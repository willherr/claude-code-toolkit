...
Four Claude Code skills I actually run, in daily use across my own apps under [will-i-am.dev](https://will-i-am.dev). Not a template or a generic starter kit: these are the real files, shared as-is, because that's more useful than a sanitized rewrite.
